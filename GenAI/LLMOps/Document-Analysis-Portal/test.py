...
#     ref_path = Path("H:\\akash\\git\\genai-architect-lab\\GenAI\\LLMOps\\Document-Analysis-Portal\\data\\document_compare\\Long_Report_V1.pdf")
#     act_path = Path("H:\\akash\\git\\genai-architect-lab\\GenAI\\LLMOps\\Document-Analysis-Portal\\data\\document_compare\\Long_Report_V2.pdf")
